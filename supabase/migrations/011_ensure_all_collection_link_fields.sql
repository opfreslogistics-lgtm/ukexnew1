-- Ensure all collection_links customization columns exist
-- This fixes any missing columns that might cause schema cache errors
...
BEGIN
  ...
  IF NOT EXISTS (
    ...
    AND column_name = 'input_background_color'
  ) THEN
  ...
  IF NOT EXISTS (
    ...
    WHERE table_schema = 'public' 
    AND table_name = 'collection_links' 
    AND column_name = 'input_text_color'
  ) THEN
  ...
  IF NOT EXISTS (
    ...
    WHERE table_schema = 'public' 
    AND table_name = 'collection_links' 
    AND column_name = 'input_border_color'
  ) THEN
  ...
  IF NOT EXISTS (
    ...
    WHERE table_schema = 'public' 
    AND table_name = 'collection_links' 
    AND column_name = 'label_text_color'
  ) THEN
  ...
  IF NOT EXISTS (
    ...
    WHERE table_schema = 'public' 
    AND table_name = 'collection_links' 
    AND column_name = 'label_background_color'
  ) THEN
    ALTER TABLE collection_links ADD COLUMN label_background_color TEXT;
  END IF;

  -- Add icon_background_color if it doesn't exist (double-check)
  IF NOT EXISTS (
    SELECT 1 FROM information_schema.columns 
    WHERE table_schema = 'public' 
    AND table_name = 'collection_links' 
  ...
  IF NOT EXISTS (
    ...
    WHERE table_schema = 'public' 
    AND table_name = 'collection_links' 
    AND column_name = 'button_background_color'
  ) THEN
  ...
  IF NOT EXISTS (
    ...
    WHERE table_schema = 'public' 
    AND table_name = 'collection_links' 
    AND column_name = 'button_alignment'
  ) THEN
  ...
  IF NOT EXISTS (
    ...
    WHERE table_schema = 'public' 
    AND table_name = 'collection_links' 
    AND column_name = 'form_background_color'
  ) THEN
  ...
  IF NOT EXISTS (
    ...
    WHERE table_schema = 'public' 
    AND table_name = 'collection_links' 
    AND column_name = 'page_background_color'
  ) THEN
